...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">论文选题网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <!--
                <li><a href="<%=basePath %>ClassInfo/frontlist.aspx">班级</a></li> 
                <li><a href="<%=basePath %>UserInfo/frontlist.aspx">用户查询</a></li>
                <li><a href="<%=basePath %>SubjectType/frontlist.aspx">题目类型</a></li>
                --> 
                
                <li><a href="<%=basePath %>Teacher/frontlist.aspx">教师查询</a></li>
                <li><a href="<%=basePath %>Subject/frontlist.aspx">论文题目</a></li>
                <li><a href="<%=basePath %>SubSelect/frontlist.aspx">学生选题</a></li>
                <li><a href="<%=basePath %>Opus/frontlist.aspx">学生成果</a></li>
                <li><a href="<%=basePath %>Video/frontlist.aspx">答辩视频</a></li>
                <li><a href="<%=basePath %>Leaveword/frontlist.aspx">留言提问</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>SubSelect/frontUserList.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的论文选题</a></li>
                        <li><a href="<%=basePath %>Opus/frontUserAdd.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;提交我的论文成果</a></li>
                        <li><a href="<%=basePath %>Opus/frontUserList.aspx"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我的论文成果查询</a></li>
                        <li><a href="<%=basePath %>UserInfo/frontSelfModify.aspx"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;修改个人资料</a></li>
                    </ul>
                </li>
