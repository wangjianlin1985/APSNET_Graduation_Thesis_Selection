<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frontList.aspx.cs" Inherits="Notice_frontList" %>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="frontAdd.aspx" style="display:none;">添加新闻公告</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>新闻id</td><td>新闻标题</td><td>发布时间</td><td>操作</td></tr>
				    					<asp:Repeater ID="RpNotice" runat="server">
 										...
 										<tr>
 											...
 											<td>
 												<a href="frontshow.aspx?noticeId=<%#Eval("noticeId")%>"><i class="fa fa-info"></i>&nbsp;查看</a>&nbsp;
 												<a href="#" onclick="noticeEdit('<%#Eval("noticeId")%>');" style="display:none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
 												<a href="#" onclick="noticeDelete('<%#Eval("noticeId")%>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										</ItemTemplate>
 										</asp:Repeater>
	...
	<div class="col-md-3 wow fadeInRight">
		<div class="page-header">
			...
			<div class="form-group">
				...
				<asp:TextBox ID="title" runat="server"  CssClass="form-control" placeholder="请输入新闻标题"></asp:TextBox>
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="notice_noticeId_edit" class="col-md-3 text-right">新闻id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="notice_noticeId_edit" name="notice.noticeId" class="form-control" placeholder="请输入新闻id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="notice_title_edit" class="col-md-3 text-right">新闻标题:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="notice_title_edit" name="notice.title" class="form-control" placeholder="请输入新闻标题">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="notice_content_edit" class="col-md-3 text-right">新闻内容:</label>
		  	 <div class="col-md-9">
			    <textarea id="notice_content_edit" name="notice.content" rows="8" class="form-control" placeholder="请输入新闻内容"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
...
function noticeDelete(noticeId) {
	if(confirm("确认删除这个记录")) {
		$.ajax({
			type : "POST",
			url : basePath + "Notice/NoticeController.aspx?action=delete",
			data : {
				noticeId : noticeId,
			},
			dataType: "json",
			success : function (obj) {
				if (obj.success) {
					alert("删除成功");
					$("#btnSearch").click();
					//location.href= basePath + "Notice/frontList.aspx";
				}
				else 
					alert(obj.message);
			},
