			...
			<div class="col-md-3 bottom15" <%#(((Container.ItemIndex+0)%4==0)?"style='clear:left;'":"") %>>
			  <a href="frontshow.aspx?teacherNo=<%#Eval("teacherNo")%>"><img class="img-responsive" src="../<%#Eval("teacherPhoto")%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		教师姓名: <%#Eval("teacherName")%>
			     	</div>
			     	<div class="field">
	            		教师性别: <%#Eval("teacherSex")%>
			     	</div>
			     	<div class="field">
	            		出生日期: <%#Eval("birthDate")%>
			     	</div>
	...
	<div class="col-md-3 wow fadeInRight">
		<div class="page-header">
			...
			<div class="form-group">
				...
				<asp:TextBox ID="teacherName" runat="server"  CssClass="form-control" placeholder="请输入教师姓名"></asp:TextBox>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="zhicheng">教师职称:</label>
				<asp:TextBox ID="zhicheng" runat="server"  CssClass="form-control" placeholder="请输入教师职称"></asp:TextBox>
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="teacher_zhicheng_edit" class="col-md-3 text-right">教师职称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="teacher_zhicheng_edit" name="teacher.zhicheng" class="form-control" placeholder="请输入教师职称">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    <textarea id="teacher_teacherDesc_edit" name="teacher.teacherDesc" rows="8" class="form-control" placeholder="请输入教师介绍"></textarea>
			 </div>
		  </div>
		</form> 
	...
	$.ajax({
		...
		success : function (teacher, response, status) {
			if (teacher) {
				...
				$("#teacher_teacherDesc_edit").val(teacher.teacherDesc);
