...
<body>
   <form id="form1" runat="server">
    <div class="div_All">
    <div class="Body_Title">用户管理 》》用户列表</div>
     <div class="Body_Search">
        学号&nbsp;&nbsp;<asp:TextBox ID="user_name" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
        所在班级&nbsp;&nbsp;<asp:DropDownList ID="classObj" runat="server"></asp:DropDownList>  &nbsp;&nbsp;
        姓名&nbsp;&nbsp;<asp:TextBox ID="name" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
        出生日期&nbsp;&nbsp; <asp:TextBox ID="birthDate"  runat="server" Width="112px" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>&nbsp;&nbsp;
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><%#Eval("user_name")%> </td>
                  <td align="center"><%#GetClassInfoclassObj(Eval("classObj").ToString())%></td>
                <td align="center"><%#Eval("name")%> </td>
                <td align="center"><%#Eval("gender")%> </td>
                  <td align="center"><%# Convert.ToDateTime(Eval("birthDate")).ToShortDateString() %></td>
