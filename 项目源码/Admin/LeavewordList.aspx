<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeavewordList.aspx.cs" Inherits="chengxusheji.Admin.LeavewordList" %>
    ...
    <asp:Repeater ID="RpLeaveword" runat="server" onitemcommand="RpLeaveword_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="LeavewordEdit.aspx?leaveWordId=<%#Eval("leaveWordId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("leaveWordId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
