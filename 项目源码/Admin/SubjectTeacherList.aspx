<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubjectTeacherList.aspx.cs" Inherits="chengxusheji.Admin.SubjectList" %>
...
<body>
   <form id="form1" runat="server">
    <div class="div_All">
    <div class="Body_Title">论文题目管理 》》论文题目列表</div>
     <div class="Body_Search">
        题目名称&nbsp;&nbsp;<asp:TextBox ID="subjectName" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
        题目类型&nbsp;&nbsp;<asp:DropDownList ID="subjectTypeObj" runat="server"></asp:DropDownList>  &nbsp;&nbsp;
    ...
    <asp:Repeater ID="RpSubject" runat="server" onitemcommand="RpSubject_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="SubjectTeacherEdit.aspx?subjectId=<%#Eval("subjectId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("subjectId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
