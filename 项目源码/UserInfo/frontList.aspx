 ...
 <form id="form1" runat="server">
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="frontList.aspx">用户信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="frontAdd.aspx" style="display:none;">添加用户</a>
		</ul>
		<div class="row">
			...
			<div class="col-md-3 bottom15" <%#(((Container.ItemIndex+0)%4==0)?"style='clear:left;'":"") %>>
			  <a href="frontshow.aspx?user_name=<%#Eval("user_name")%>"><img class="img-responsive" src="../<%#Eval("userPhoto")%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		所在班级:<%#GetClassInfoclassObj(Eval("classObj").ToString())%>
			     	</div>
			     	<div class="field">
	            		姓名: <%#Eval("name")%>
			     	</div>
	...
	<div class="col-md-3 wow fadeInRight">
		<div class="page-header">
			...
			<div class="form-group">
				...
				<asp:TextBox ID="user_name" runat="server"  CssClass="form-control" placeholder="请输入学号"></asp:TextBox>
			</div>
            <div class="form-group">
            	<label for="classObj_classNo">所在班级：</label>
                <asp:DropDownList ID="classObj" runat="server"  CssClass="form-control" placeholder="请选择所在班级"></asp:DropDownList>
            </div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<asp:TextBox ID="birthDate"  runat="server" CssClass="form-control" placeholder="请选择出生日期" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_classObj_classNo_edit" class="col-md-3 text-right">所在班级:</label>
		  	 <div class="col-md-9">
			    <select id="userInfo_classObj_classNo_edit" name="userInfo.classObj.classNo" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				$.ajax({
					url: basePath + "ClassInfo/ClassInfoController.aspx?action=listAll",
					type: "get",
					dataType: "json",
					success: function(classInfos,response,status) { 
						$("#userInfo_classObj_classNo_edit").empty();
						var html="";
		        		$(classInfos).each(function(i,classInfo){
		        			html += "<option value='" + classInfo.classNo + "'>" + classInfo.className + "</option>";
		        		});
		        		$("#userInfo_classObj_classNo_edit").html(html);
		        		$("#userInfo_classObj_classNo_edit").val(userInfo.classObjPri);
					}
				});
