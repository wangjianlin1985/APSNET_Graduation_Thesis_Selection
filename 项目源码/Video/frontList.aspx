		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="frontAdd.aspx" style="display:none;">添加答辩视频</a></li>
				</ul>
			  	<!-- Tab panes -->
	...
	<div class="col-md-3 wow fadeInRight">
		<div class="page-header">
            ...
            <div class="form-group">
            	<label for="subjectObj_videoId">论文题目：</label>
                <asp:DropDownList ID="subjectObj" runat="server"  CssClass="form-control" placeholder="请选择论文题目"></asp:DropDownList>
            </div>
            <div class="form-group">
            	<label for="userObj_videoId">答辩学生：</label>
                <asp:DropDownList ID="userObj" runat="server"  CssClass="form-control" placeholder="请选择答辩学生"></asp:DropDownList>
            </div>
			<div class="form-group">
				<label for="videoDate">答辩日期:</label>
				<asp:TextBox ID="videoDate"  runat="server" CssClass="form-control" placeholder="请选择答辩日期" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>
			</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    <textarea id="video_videoMemo_edit" name="video.videoMemo" rows="8" class="form-control" placeholder="请输入附加信息"></textarea>
			 </div>
		  </div>
		</form> 
	...
	$.ajax({
		...
		success : function (video, response, status) {
			if (video) {
				...
				$("#video_videoMemo_edit").val(video.videoMemo);
